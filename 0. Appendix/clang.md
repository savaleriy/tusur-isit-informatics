...
Физика — это искусство давать явлениям точные имена, и в программировании то же самое! Вот несколько простых правил, чтобы не запутаться самим и не запутать других:
...
Конечно! Вот перевод и пересказ в стиле Ричарда Фейнмана — просто, ясно, с примерами и энтузиазмом, будто я объясняю это вам за доской.
