...
<figure class="epigraph">
  <blockquote>
    <p>Со временем компьютерные системы не становятся более безопасными. Но я надеюсь, что успехи, которые мы делаем в криптографии, исправят плачевную ситуацию в области кибербезопасности.</p>
  </blockquote>
  <figcaption>
    <img src="../images/portraits/shamir.jpg" alt="">
    Ади Шамир
  </figcaption>
</figure>
