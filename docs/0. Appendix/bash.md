...
# Обратите внимание: необходимо, чтобы "scriptbc" (сценарий N 9) находился в одном из каталогов, перечисленных в PATH, потому что он неоднократно вызывается в данном сценарии.
